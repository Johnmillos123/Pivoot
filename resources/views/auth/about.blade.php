...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" style="color:rgb(10, 9, 9);" href="#" id="navbarDropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Inicio</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item active" href="{{ 'index' }}">Inicio</a>
                            <a class="dropdown-item" href="{{ 'pivoot' }}">Equipo desarrollador</a>
                        </div>
                    </li>
    ...
    <main class="bg-light">
        ...
        <div class="page-hero-section bg-image hero-mini" style="background-image: url(../img/hero_mini.svg);">
            <div class="hero-caption">
                <div class="container fg-white h-100">
                    <div class="row justify-content-center align-items-center text-center h-100">
                        <div class="col-lg-6">
                            <h3 class="mb-4 fw-medium" style="color:rgb(10, 9, 9);">Equipo desarrollador</h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-dark justify-content-center bg-transparent">
                                    <br>
                                    <li class="breadcrumb-item"><a href="{{ 'index' }}"
                                            style="color:rgb(10, 9, 9);">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page" style="color:rgb(10, 9, 9);">
                                        Equipo desarrollador</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card-page">
                            <div class="card-page mt-3">
                                <h5 style="color:rgb(10, 9, 9);">Conozca nuestro equipo de desarrolladores.</h5>
                                <hr>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3 py-3">
                                        <div class="team-item">
                                            <div class="team-avatar">
                                                <img src="../img/person/person_1.png" alt="">
                                            </div>
                                    ...
                                    <div class="col-lg-3 py-3">
                                        <div class="team-item">
                                            <div class="team-avatar">
                                                <img src="../img/person/person_2.png" alt="">
                                            </div>
                                    ...
                                    <div class="col-lg-3 py-3">
                                        <div class="team-item">
                                            <div class="team-avatar">
                                                <img src="../img/person/person_3.png" alt="">
                                            </div>
        ...
        <div class="container">
            <div class="row mb-5 py-3">
                ...
                <div class="col-sm-6 col-lg-2 py-3">
                    ...
                    <p>Bogotá<br>
                        calle 60 sur No 22A - 65 2 piso<br>
                    </p>
                </div>
                <div class="col-md-6 col-lg-4 py-3">
                    ...
                    <p>
                        lunes: Cerrado <br>
                        martes: Cerrado <br>
                        miércoles: 16:30 – 18:00 <br>
                        jueves: 16:30 – 18:00 <br>
                        viernes: Cerrado <br>
                        sábado: 7:00 – 13:00 <br>
                        domimgo: 7:00 – 13:00 <br>
                    </p>
                </div>
                <!-- Social Media Button -->
                <div class="mt-4">
