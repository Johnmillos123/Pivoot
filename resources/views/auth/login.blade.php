                            ...
                            <form method="POST" action="{{ url('login') }}" class="signin-form">
                                ...
                                <div class="form-group d-md-flex">
                                    <div class="w-50 text-left">
                                        <label  class="checkbox-wrap checkbox-primary mb-0"><a href="{{ 'politica-privacidad' }}">Política de privacidad</a>
                                            <input name="politica-privacidad" required  type="checkbox">
