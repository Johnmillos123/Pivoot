                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Novedad</h4> <button type="button" class="btn btn-primary" data-toggle="modal"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($Novedad as $Novedad)
                                                <tr>
                                                    ...
                                                    <td>{{ $Novedad->descripcionNovedad }}</td>

                                                    <td>
                                                        <a type="button"
                                                                href="{{ url('Novedad/' . $Novedad->idNovedad) }}"
                                                                class="btn btn-primary shadow btn-xs sharp mr-1 fa fa-eye" data-toggle="modal"
                                                                data-target="#Modal{{ $Novedad->idNovedad }}">
                                                                </a>

                                                        <div class="modal fade" id="Modal{{ $Novedad->idNovedad }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <ul>
                                                                            <li><strong>Identrenamiento: </strong>{{ $Novedad->Entrenamiento()->first()->lugarEntrenamiento}}</li><br>
                                                                            <li><strong>idUsuario: </strong>{{ $Novedad->users()->first()->name }}</li><br>
                                                                            <li><strong>Fecha de novedad: </strong>{{ $Novedad->fechaNovedad }}</li><br>
                                                                            <li><strong>Descripcion de novedad: </strong>{{ $Novedad->descripcionNovedad }}</li><br>
                                                        ...
                                                        <div class="modal fade" id="update{{ $Novedad->idNovedad }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="ModalLabel">
                                                                            <strong>{{ $Novedad ->descipcionNovedad }}</strong>
                                                                        </h5>
                                                                        <button type="button"
                                                                            class="close"
                                                                            data-dismiss="modal" aria-label="Close">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <center>
                                                                            <form method="POST"
                                                                                action="{{ url('Novedad/' . $Novedad->idNovedad) }}"
                                                                                class="form-horizontal formulario-editar">
                                                                                @method('PUT')
                                                                                @csrf
                                                                                <div class="form-group">
                                                                                    <label for="recipient-name"
                                                                                        class="col-form-label">idNovedad
                                                                                        <span
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="recipient-name"
                                                                                        class="col-form-label">Entrenamiento
                                                                                        <span
                                                                                            class="text-danger">*</span>
                                                                                    </label>
                                                                                <select class="form-control default-select" aria-label="Default select example"
                                                                                    class="box" value="{{ old('idEntrenamientoFK') }}" name="idEntrenamientoFK" required id="">
                                                                                    <option value="">seleccione el lugar de entrenamiento</option>
                                                                                     @foreach ($Entrenamiento as $Entrenamientos)
                                                                                      <option value="{{ $Entrenamientos->idEntrenamiento }}">
                                                                                     {{ $Entrenamientos->lugarEntrenamiento }}
                                                                                     </option>
                                                                                        @endforeach
                                                                                </select>
                                                                                    <!--<strong
                                                                                ...
                                                                                <select class="form-control default-select" aria-label="Default select example"
                                                                                    class="box" value="{{ old('idUsuarioFK') }}" name="idUsuarioFK" required id="">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="recipient-name"
                                                                                        class="col-form-label">descripcion de novedad
                                                                                        <span
                                                                                            class="text-danger">*</span>
                                                                                    </label>
                                                                                    <input
                                                                                        value="{{ $Novedad->descripcionNovedad }}"
                                                    ...
                                                    <td>
                                                        @switch ($Novedad->habilitado)
                                                            @case(null)
                                                                <a>

                                                                    <a href="{{ url('Novedad/' . $Novedad->idNovedad . '/habilitar') }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h5 class="modal-title" id="exampleModalLabel"><strong>Nueva Novedad</strong>
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ url('Novedad') }}"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-10 control-label" for="textinput">lugar Entrenamiento :</label>
                                                        <div class="col-md-10">
                                                                <select class="form-control default-select" aria-label="Default select example"
                                                                    class="box" name="idEntrenamientoFK" required id="">
                                                                    <option value="">seleccione el entrenamiento</option>
                                                                    @foreach ($Entrenamiento as $Entrenamiento)
                                                                        <option value="{{ $Entrenamiento->idTipoEntrenamientoFK }}">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-10 control-label" for="textinput">usuario :</label>
                                                            <div class="col-md-10">
                                                                <select class="form-control default-select" aria-label="Default select example"
                                                                    class="box" name="idUsuarioFK" required id="">
                                                                    <option value="">seleccione el jugador</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-10 control-label" for="textinput">Fecha:</label>
                                                        <div class="col-md-10">
                                                            <input name="fechaNovedad" type="date" class="form-control input-md">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input name="descripcionNovedad" type="text" placeholder="Ingrese la descripcion de la novedad"
