                                                        ...
                                                        <td>
                                                            @switch ($jugadores->habilitado)
                                                                @case(null)
                                                                    <a>
                                                                        ...
                                                                        <a href="{{ url('jugadores/' . $jugadores->idJugador . '/habilitar') }}"
                                                                            class="btn btn-success boton-habilitar" id="habilitar">
                                                                            Habilitar
                                                                        </a>
                                                                ...
                                                                @case(1)
                                                                    ...
                                                                    <a href="{{ url('jugadores/' . $jugadores->idJugador . '/habilitar') }}"
                                                                        class="btn btn-warning boton-inhabilitar" id="habilitar">
                                                                        Inhabilitar
                                                                    </a>
                                                                ...
                                                                @case(2)
                                                                    ...
                                                                    <a href="{{ url('jugadores/' . $jugadores->idJugadores . '/habilitar') }}"
                                                                        class="btn btn-success" id="habilitar">
                                                                        Habilitar
                                                                    </a>
...
<script>
    $('.formulario-confirmar').submit(function(e){
     ...
     Swal.fire({
     title: '¿Estás seguro?',
     text: "¡Se registrará este jugador!",
     icon: 'warning',
